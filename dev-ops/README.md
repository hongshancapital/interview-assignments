...
- 应用程序具备可伸缩弹性，运行在Docker容器中，您可以使用[此仓库](https://github.com/goxr3plus/Simplest-Spring-Boot-Hello-World)的源代码（递交您设计的自动构建代码或配置）
...
- 可以监控环境、应用的日志，当出现错误日志和内存不足时产生邮件警报（递交您的配置或代码）；
