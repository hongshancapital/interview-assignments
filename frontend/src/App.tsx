  ...
  const InfoList = useMemo(() => {
    return [
      ...
      },
      {
        ...
        image: <img src={require('./assets/tablet.png')} style={{width: '100%', position: 'absolute', bottom: '150px', left: 0}}></img>
      },
      {
        title: `Buy a Tablet or Phone for college.\nGet arPods.`,
        theme: Theme.GrayTheme,
        image: <img src={require('./assets/airpods.png')} style={{width: '100%', position: 'absolute', bottom: '150px', left: 0}}></img>
      }
    ]
  }, [])
