                ...
                .onChange(of: isHeaderRefreshing, perform: { value in
                    if !value {
                        ...
                        if !listState.noMore {
                            ...
                            self.footerRefreshData.refreshState = .noMore
                        }
                    }
                })
...
extension PullToRefreshModifier {
    ...
    private func calculateFooterRefreshState(_ proxy: GeometryProxy, value: [FooterBoundsPreferenceKey.Item]) {
        ...
        if (footerRefreshData.refreshState == .loading || footerRefreshData.refreshState == .noMore) {
            return
        }
        ...
        let contentOffset = scrollViewHeight - y
