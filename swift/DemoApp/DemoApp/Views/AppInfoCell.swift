    ...
    var body: some View {
        HStack {
            ...
            Image(systemName: appInfo.isFavorite ? "heart.fill" : "heart")
                ...
                .scaleEffect(appInfo.isFavorite ? 1.4 : 1.4)
