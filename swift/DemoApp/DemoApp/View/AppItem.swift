    ...
    var body: some View{
        HStack {
             ...
             Button {
                 ...
                 Label(NSLocalizedString("Toggle Favorite",comment: ""), systemImage: modelData.favoriteAppIds.contains(appInfo.trackId) ? "heart.fill" : "heart")
                     .labelStyle(.iconOnly)
...
struct AppItem_Previews: PreviewProvider {
    static var previews: some View {
        AppItem(appInfo: ModelData().appInfos[0])
