...
class UnitTesting_AppListDataService_Tests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        allAppInfos =  TestDatasHelper.loadMockData()
    }
    ...
    func test_AppListDataService_fetchAppInfos_shouldReturnedRightDatas() async throws {
        ...
        for _ in 0...999 {
            ...
            let collected = TestDatasHelper.fetchCollectedApps()
            // 随机生成页数和每页数据条数
    ...
    func test_AppListDataService_updateCollectedApps_shouldUpdateCollectedApps() throws {
        ...
        for _ in 0...999 {
            ...
            // 随机取一个模型
            let oldCollected = TestDatasHelper.fetchCollectedApps()
            ...
            let newCollected = TestDatasHelper.fetchCollectedApps()
