...
struct FixedView: View {
    var body: some View {
        GeometryReader { proxy in
            Color(uiColor: .secondarySystemBackground).preference(key: RefreshableKeyTypes.PrefKey.self, value: [RefreshableKeyTypes.PrefData(vType: .fixedView, bounds: proxy.frame(in: .global))])
...
//        let parentView: ActivityRep
//        init(parentView: ActivityRep){
