...
extension View {
    func addPullToRefresh(isHeaderRefreshing: Binding<Bool>?, onHeaderRefresh: (() -> Void)?, noMoreRefresh: Binding<Bool>?) -> some View {
        addPullToRefresh(isHeaderRefreshing: isHeaderRefreshing, onHeaderRefresh: onHeaderRefresh, isFooterRefreshing: nil, onFooterRefresh: nil, noMoreRefresh: .constant(false))
    }
    
    func addPullToRefresh(isFooterRefreshing: Binding<Bool>?, onFooterRefresh: (() -> Void)?, noMoreRefresh: Binding<Bool>?) -> some View {
        addPullToRefresh(isHeaderRefreshing: nil, onHeaderRefresh: nil, isFooterRefreshing: isFooterRefreshing, onFooterRefresh: onFooterRefresh, noMoreRefresh: noMoreRefresh)
    }
    
    func addPullToRefresh(isHeaderRefreshing: Binding<Bool>?, onHeaderRefresh: (() -> Void)?, isFooterRefreshing: Binding<Bool>?, onFooterRefresh: (() -> Void)?, noMoreRefresh: Binding<Bool>?) -> some View {
        modifier(PullToRefreshModifier(isHeaderRefreshing: isHeaderRefreshing, isFooterRefreshing: isFooterRefreshing, onHeaderRefresh: onHeaderRefresh, onFooterRefresh: onFooterRefresh, noMoreRefresh: noMoreRefresh))
    }
}
...
struct PullToRefreshModifier: ViewModifier {
    ...
    @Binding var noMoreRefresh: Bool
//    @Binding var listState: ListState
    
    let onHeaderRefresh: (() -> Void)?
    let onFooterRefresh: (() -> Void)?
        
    init(isHeaderRefreshing: Binding<Bool>?, isFooterRefreshing: Binding<Bool>?, onHeaderRefresh: (() -> Void)?, onFooterRefresh: (() -> Void)? ,noMoreRefresh: Binding<Bool>?) {
        ...
        self._noMoreRefresh = noMoreRefresh ?? .constant(false)
//        self._listState = .constant(ListState())
    }
...
//        let contentTop = contentFrame.minY // 未滚动时为0，滚动后为负值
        ...
        let bottomDistance: CGFloat = 40.0
