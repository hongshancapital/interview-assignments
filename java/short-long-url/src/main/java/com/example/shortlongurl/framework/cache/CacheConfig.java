package com.example.shortlongurl.framework.cache;

import com.example.shortlongurl.web.service.IDKeyGenerator;
import com.example.shortlongurl.web.service.impl.IDKeyGeneratorImpl;
...
public class CacheConfig{
    ...
    @Bean
    public IDKeyGenerator idKeyGenerator(){
        return new IDKeyGeneratorImpl();
    }
