<div align="center" style="font-size:42px" > 短域名服务需求与程序说明文档 </div> 
...
> 预计每月生成500M个新的短URL，每秒200，读写操作数量比100:1，每月重定向（读）为500Mx100=50B， 每秒20K
...
> 那么20%的URL产生了80%的流量，我们将对top20%的URL做cache。 每个月生成的新URL为500M，top20%大约100M， 
> 总共需要100Mx500B=500MB。 如果我们想cache更长时段的URL，则需要更大的空间。

> 带宽：每秒会有200写操作（新URL），所以总共上传数据带宽为100KB/s ，对于读操作20K/s，下载带宽为10MB/s
