	 ...
	 @Bean
	    public OpenAPI customOpenAPI(@Value("${springdoc.version}") String appVersion) {
	        return new OpenAPI()
	                ...
	                .info(new Info().title("Domain Service API").version(appVersion)
	                        .description("This is the RESTful service of Domain Service using springdoc-openapi and OpenAPI 3."));
	    }
}
