...
@Api(tags = "MD5短链接生成相关接口")
public class Md5ShortUrlController {

    @Autowired
    private Md5GeneratorShortUrlHandler md5GeneratorShortUrlHandler;
    ...
    public BaseResponse<String> toShortUrl(@RequestParam(name = "url") String url){
        ...
        String value = md5GeneratorShortUrlHandler.put(url);
    ...
    public BaseResponse<String> getUrl(@RequestParam(name = "url") String url){
        ...
        String value = md5GeneratorShortUrlHandler.getValue(url);
