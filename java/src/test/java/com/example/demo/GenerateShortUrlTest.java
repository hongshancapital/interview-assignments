...
class GenerateShortUrlTest {
    ...
    public void test() throws Exception {
        ...
        System.out.println("abcd, 短链接:" + mvcResult.getResponse().getContentAsString());
        ...
        System.out.println("123, 短链接:" + mvcResult.getResponse().getContentAsString());
    }
}
