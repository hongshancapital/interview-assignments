...
@State(Scope.Thread)
public class RandomIdTransformerWriteBenchmarkTest {

	public static void main(String[] args) throws Exception {
		Options opt = new OptionsBuilder().include(RandomIdTransformerWriteBenchmarkTest.class.getSimpleName())
				.forks(1)
				.build();
		new Runner(opt).run();
	}
	...
	public void test() throws InterruptedException {
		...
		randomIdTransformer.transformFromOriginalUrlToTinyUrl("www.test.com");
	}
