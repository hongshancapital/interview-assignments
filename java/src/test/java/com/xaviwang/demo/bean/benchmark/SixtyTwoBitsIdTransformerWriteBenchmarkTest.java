...
@State(Scope.Thread)
public class SixtyTwoBitsIdTransformerWriteBenchmarkTest {

	public static void main(String[] args) throws Exception {
		Options opt = new OptionsBuilder().include(SixtyTwoBitsIdTransformerWriteBenchmarkTest.class.getSimpleName())
				.forks(1)
				.build();
		new Runner(opt).run();
	}
	...
	public void test() throws InterruptedException {
		...
		sixtyTwoBitsIdTransformer.transformFromOriginalUrlToTinyUrl("www.test.com");
	}
