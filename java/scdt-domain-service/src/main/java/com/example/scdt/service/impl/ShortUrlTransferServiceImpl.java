 ...
 */
@Service
public class ShortUrlTransferServiceImpl implements IShortUrlTransferService {

    public static final Logger log = LoggerFactory.getLogger(ShortUrlTransferServiceImpl.class);
     ...
     */
    @Override
    public String shortUrlToLongUrl(String shortUrl) throws BusinessException {
        ...
        if (StringUtils.isEmpty(longUrl)) {
            ...
            throw new BusinessException(CommonRespCode.READ_FAIL.getCode(), CommonRespCode.READ_FAIL.getMsg());
        }
